...
const EXTRA_FOODS = [
  ...
  // ── DAUGIAU PERDIRBTOS MĖSOS / ŠALTIEJI PJŪKLAI ───────────────────────
  { id:"chicken_ham",  name:"Vištienos kumpis",            barcode:"4770077010017", category:"Perdirbta mėsa", kcal:105, protein:18,   fat:2.5,  carbs:1.5, units:[{label:"2 riekelės (60g)",grams:60},{label:"4 riekelės",grams:120}] },
  { id:"turkey_ham",   name:"Kalakutienos kumpis",         category:"Perdirbta mėsa", kcal:98,  protein:17,   fat:2,    carbs:2,   units:[{label:"2 riekelės (60g)",grams:60},{label:"4 riekelės",grams:120}] },
  { id:"pork_ham_sm",  name:"Kiaulienos kumpis (rūkytas)", barcode:"4770077020016", category:"Perdirbta mėsa", kcal:130, protein:18,   fat:5,    carbs:2,   units:[{label:"2 riekelės (60g)",grams:60}] },
  { id:"mortadella",   name:"Mortadela",                   category:"Perdirbta mėsa", kcal:311, protein:14,   fat:28,   carbs:1.6, units:[{label:"2 riekelės (40g)",grams:40}] },
  { id:"bologna",      name:"Bolonijos dešra",             category:"Perdirbta mėsa", kcal:266, protein:12,   fat:24,   carbs:2,   units:[{label:"2 riekelės (50g)",grams:50}] },
  { id:"saus_pork",    name:"Kiaulienos dešrelė (virta)",  category:"Perdirbta mėsa", kcal:290, protein:13,   fat:26,   carbs:2,   units:[{label:"1 vnt (52g)",grams:52},{label:"2 vnt",grams:104}] },
  { id:"black_pud",    name:"Juodasis pudingas (kraujo)",  category:"Perdirbta mėsa", kcal:325, protein:14,   fat:22,   carbs:20,  units:[{label:"1 riekelė (50g)",grams:50}] },
  { id:"liverwurst",   name:"Kepenų paštetas",             category:"Perdirbta mėsa", kcal:326, protein:14,   fat:28,   carbs:3,   units:[{label:"1 šaukštas (20g)",grams:20},{label:"2 šaukštai (40g)",grams:40}] },
  { id:"pate_chick",   name:"Vištienos paštetas",          barcode:"4770077030015", category:"Perdirbta mėsa", kcal:198, protein:12,   fat:15,   carbs:4,   units:[{label:"1 šaukštas (20g)",grams:20},{label:"50g",grams:50}] },
  { id:"pate_pork",    name:"Kiaulienos paštetas",         category:"Perdirbta mėsa", kcal:310, protein:12,   fat:28,   carbs:2.5, units:[{label:"1 šaukštas (20g)",grams:20}] },
  { id:"smoked_chick", name:"Rūkyta vištiena",             category:"Perdirbta mėsa", kcal:201, protein:30,   fat:9,    carbs:0,   units:[{label:"porcija (100g)",grams:100}] },
  { id:"smoked_pork",  name:"Rūkyta kiauliena",            category:"Perdirbta mėsa", kcal:280, protein:20,   fat:22,   carbs:0,   units:[{label:"porcija (100g)",grams:100}] },
  { id:"corned_beef",  name:"Konservuota jautiena",        barcode:"5010044003671", category:"Perdirbta mėsa", kcal:185, protein:24,   fat:9,    carbs:0,   units:[{label:"½ skardinė (100g)",grams:100}] },
  { id:"spam",         name:"SPAM (kiaulienos konservas)",  barcode:"5010379088606", category:"Perdirbta mėsa", kcal:310, protein:13,   fat:27,   carbs:3,   units:[{label:"2 riekelės (57g)",grams:57}] },

  // ── DAUGIAU VIŠTIENOS ─────────────────────────────────────────────────
  { id:"chick_gr_b",   name:"Vištienos krūtinėlė (ant grotelių)", category:"Mėsa – vištiena", kcal:185, protein:35,   fat:4,    carbs:0,   units:[{label:"1 porcija (150g)",grams:150}] },
  { id:"chick_fry",    name:"Vištienos krūtinėlė (paniruota, kepta)", category:"Mėsa – vištiena", kcal:246, protein:28,   fat:12,   carbs:7,   units:[{label:"1 porcija (150g)",grams:150}] },
  { id:"chick_nugget", name:"Vištienos gabaliukai (namuose kepti)", category:"Mėsa – vištiena", kcal:250, protein:17,   fat:14,   carbs:13,  units:[{label:"5 vnt (100g)",grams:100}] },
  { id:"chick_kebab",  name:"Vištienos kebabas (ant pagaliuko)",   category:"Mėsa – vištiena", kcal:165, protein:25,   fat:6,    carbs:2,   units:[{label:"1 pagaliukas (100g)",grams:100}] },
  { id:"chick_stir",   name:"Vištiena (troškinta su daržovėmis)", category:"Mėsa – vištiena", kcal:175, protein:22,   fat:7,    carbs:7,   units:[{label:"1 porcija (200g)",grams:200}] },
  { id:"turkey_min",   name:"Kalakutienos maltinukai",            category:"Mėsa – vištiena", kcal:148, protein:22,   fat:6,    carbs:0,   units:[{label:"1 porcija (150g)",grams:150}] },
  { id:"turkey_sl",    name:"Kalakutienos riekelės (šaltos)",     category:"Perdirbta mėsa", kcal:109, protein:17,   fat:3,    carbs:3,   units:[{label:"2 riekelės (56g)",grams:56}] },

  // ── DAUGIAU JAUTIENOS / KIAULIENOS ────────────────────────────────────
  { id:"beef_burg",    name:"Jautienos burgeris (kepta kotl.)",   category:"Mėsa – raudona", kcal:295, protein:20,   fat:23,   carbs:0,   units:[{label:"1 kotletas (113g)",grams:113}] },
  { id:"beef_mince_5", name:"Jautienos maltinukai (5% riebalų)", category:"Mėsa – raudona", kcal:137, protein:22,   fat:5,    carbs:0,   units:[{label:"1 porcija (150g)",grams:150}] },
  { id:"beef_roast",   name:"Jautiena (orkaitėje kepta)",         category:"Mėsa – raudona", kcal:215, protein:32,   fat:10,   carbs:0,   units:[{label:"1 porcija (150g)",grams:150}] },
  { id:"beef_brisket", name:"Jautienos krūtinėlė (troškinta)",   category:"Mėsa – raudona", kcal:271, protein:22,   fat:20,   carbs:0,   units:[{label:"1 porcija (150g)",grams:150}] },
  { id:"pork_belly",   name:"Kiaulienos šoninė (kepta)",         category:"Mėsa – raudona", kcal:518, protein:19,   fat:50,   carbs:0,   units:[{label:"porcija (100g)",grams:100}] },
  { id:"pork_min",     name:"Kiaulienos maltinukai",              category:"Mėsa – raudona", kcal:263, protein:17,   fat:22,   carbs:0,   units:[{label:"1 porcija (150g)",grams:150}] },
  { id:"pork_tendl",   name:"Kiaulienos nugarinė (kepta)",       category:"Mėsa – raudona", kcal:189, protein:26,   fat:9,    carbs:0,   units:[{label:"1 porcija (150g)",grams:150}] },
  { id:"meatball",     name:"Mėsos kukuliai (jautiena/kiauliena)",category:"Mėsa – raudona", kcal:258, protein:17,   fat:18,   carbs:7,   units:[{label:"4 vnt (100g)",grams:100},{label:"6 vnt (150g)",grams:150}] },
  { id:"meat_loaf",    name:"Mėsos kepsnys (meatloaf)",          category:"Mėsa – raudona", kcal:196, protein:15,   fat:10,   carbs:12,  units:[{label:"1 riekelė (85g)",grams:85}] },

  // ── DAUGIAU ŽUVIES ───────────────────────────────────────────────────
  { id:"trout",        name:"Upėtakis (keptas)",                  category:"Žuvis", kcal:190, protein:26,   fat:9,    carbs:0,   units:[{label:"1 filė (150g)",grams:150}] },
  { id:"tilapia",      name:"Tilapija (keptas)",                  category:"Žuvis", kcal:129, protein:26,   fat:2.7,  carbs:0,   units:[{label:"1 filė (100g)",grams:100}] },
  { id:"sea_bass",     name:"Jūrinis ešerys (keptas)",            category:"Žuvis", kcal:124, protein:24,   fat:2.5,  carbs:0,   units:[{label:"1 porcija (150g)",grams:150}] },
  { id:"catfish",      name:"Šamas (keptas)",                     category:"Žuvis", kcal:229, protein:27,   fat:13,   carbs:0,   units:[{label:"1 filė (150g)",grams:150}] },
  { id:"anchovies",    name:"Ančiuviai (konservuoti)",            barcode:"3168930002890", category:"Žuvis", kcal:210, protein:29, fat:10, carbs:0, units:[{label:"¼ skardinė (20g)",grams:20}] },
  { id:"salmon_sm",    name:"Lašiša (rūkyta)",                    barcode:"4770077040014", category:"Žuvis", kcal:117, protein:18,   fat:4.3,  carbs:0.5, units:[{label:"2 riekelės (60g)",grams:60}] },
  { id:"pollock",      name:"Pollackas / Mintajus (keptas)",      category:"Žuvis", kcal:111, protein:23,   fat:1.3,  carbs:0,   units:[{label:"1 filė (100g)",grams:100}] },

  // ── DAUGIAU PIENO / SŪRIO ────────────────────────────────────────────
  { id:"feta",         name:"Feta sūris",                         barcode:"5201056000014", category:"Pieno produktai", kcal:264, protein:14,   fat:21,   carbs:4,   units:[{label:"kubelis (30g)",grams:30},{label:"50g",grams:50}] },
  { id:"ricotta",      name:"Ricotta sūris",                      category:"Pieno produktai", kcal:174, protein:11,   fat:13,   carbs:3,   units:[{label:"2 šaukštai (60g)",grams:60}] },
  { id:"haloumi",      name:"Haloumi (keptas)",                   category:"Pieno produktai", kcal:321, protein:22,   fat:26,   carbs:0.5, units:[{label:"2 riekelės (60g)",grams:60}] },
  { id:"edam",         name:"Edamo sūris",                        category:"Pieno produktai", kcal:357, protein:25,   fat:28,   carbs:1.4, units:[{label:"1 riekelė (30g)",grams:30}] },
  { id:"emmental",     name:"Ementalio sūris",                    category:"Pieno produktai", kcal:380, protein:29,   fat:29,   carbs:0,   units:[{label:"1 riekelė (30g)",grams:30}] },
  { id:"cheddar_sl",   name:"Čederis (sūrio riekelė, lydytas)",   barcode:"7622210028839", category:"Pieno produktai", kcal:330, protein:18, fat:27, carbs:4, units:[{label:"1 riekelė (20g)",grams:20}] },
  { id:"quark",        name:"Quark (varškės sūrelis)",            category:"Pieno produktai", kcal:69,  protein:11,   fat:0.2,  carbs:4,   units:[{label:"1 indelis (150g)",grams:150}] },
  { id:"milk_choc_drk",name:"Šokoladinis pienas (paruoštas)",     category:"Pieno produktai", kcal:83,  protein:3.4,  fat:2.2,  carbs:14,  units:[{label:"stiklinė 200ml",grams:200}] },
  { id:"puding_van",   name:"Pudingas (vanilininis, paruoštas)",  category:"Pieno produktai", kcal:125, protein:3.1,  fat:3.2,  carbs:21,  units:[{label:"1 indelis (120g)",grams:120}] },

  // ── DAUGIAU DARŽOVIŲ ─────────────────────────────────────────────────
  { id:"carrot_raw",   name:"Morka (žalia)",                      category:"Daržovės", kcal:41,  protein:0.9,  fat:0.2,  carbs:10,  units:[{label:"1 morka (80g)",grams:80},{label:"2 morkos",grams:160}] },
  { id:"carrot_coo",   name:"Morka (virta)",                      category:"Daržovės", kcal:35,  protein:0.8,  fat:0.2,  carbs:8,   units:[{label:"1 morka (80g)",grams:80}] },
  { id:"parsnip",      name:"Pastarnokas (virtas)",               category:"Daržovės", kcal:75,  protein:1.3,  fat:0.3,  carbs:18,  units:[{label:"1 porcija (100g)",grams:100}] },
  { id:"turnip",       name:"Ropė (virta)",                       category:"Daržovės", kcal:22,  protein:0.9,  fat:0.1,  carbs:5,   units:[{label:"1 porcija (100g)",grams:100}] },
  { id:"fennel",       name:"Fenkolis",                           category:"Daržovės", kcal:31,  protein:1.2,  fat:0.2,  carbs:7,   units:[{label:"1 porcija (100g)",grams:100}] },
  { id:"artichoke_fr", name:"Artišokas (šviežias, virtas)",       category:"Daržovės", kcal:47,  protein:3.3,  fat:0.2,  carbs:11,  units:[{label:"1 vnt (120g)",grams:120}] },
  { id:"watercress",   name:"Rūgštynės / Nasturtium",             category:"Daržovės", kcal:11,  protein:2.3,  fat:0.1,  carbs:1.3, units:[{label:"sauja (30g)",grams:30}] },
  { id:"bok_choy",     name:"Bok Choy (kiniškas kopūstas, virtas)", category:"Daržovės", kcal:12, protein:1.6, fat:0.2, carbs:1.8, units:[{label:"1 porcija (100g)",grams:100}] },
  { id:"okra",         name:"Okra (virta)",                       category:"Daržovės", kcal:33,  protein:1.9,  fat:0.2,  carbs:7.5, units:[{label:"1 porcija (100g)",grams:100}] },
  { id:"spring_oni",   name:"Svogūnai (žalieji)",                 category:"Daržovės", kcal:32,  protein:1.8,  fat:0.2,  carbs:7.3, units:[{label:"2 stiebeliai (20g)",grams:20}] },
  { id:"potato_mash",  name:"Bulvių košė (su pienu)",             category:"Daržovės", kcal:83,  protein:2.1,  fat:1.2,  carbs:17,  units:[{label:"porcija (200g)",grams:200}] },
  { id:"potato_baked", name:"Kepta bulvė orkaitėje",              category:"Daržovės", kcal:93,  protein:2.5,  fat:0.1,  carbs:21,  units:[{label:"1 vidutin. (200g)",grams:200}] },
  { id:"potato_fried", name:"Keptos bulvės keptuvėje",            category:"Daržovės", kcal:210, protein:3,    fat:10,   carbs:27,  units:[{label:"porcija (150g)",grams:150}] },

  // ── DAUGIAU GRŪDŲ / MAKARONŲ ─────────────────────────────────────────
  { id:"pasta_penne",  name:"Penne makaronai (virti)",            category:"Grūdai", kcal:158, protein:5.8,  fat:0.9,  carbs:31,  units:[{label:"porcija (200g)",grams:200}] },
  { id:"pasta_spag",   name:"Spagečiai (virti)",                  category:"Grūdai", kcal:158, protein:5.8,  fat:0.9,  carbs:31,  units:[{label:"porcija (200g)",grams:200}] },
  { id:"pasta_gf",     name:"Makaronai (be glitimo, virti)",      category:"Grūdai", kcal:145, protein:2.5,  fat:0.8,  carbs:32,  units:[{label:"porcija (200g)",grams:200}] },
  { id:"noodles_egg",  name:"Kiaušinių makaronai (virti)",        category:"Grūdai", kcal:138, protein:4.5,  fat:2.2,  carbs:25,  units:[{label:"porcija (200g)",grams:200}] },
  { id:"noodles_rice", name:"Ryžių makaronai (virti)",            category:"Grūdai", kcal:108, protein:0.9,  fat:0.2,  carbs:25,  units:[{label:"porcija (200g)",grams:200}] },
  { id:"ramen_dry",    name:"Ramen makaronai (sausi, greitai virt.)", barcode:"8934673560018", category:"Grūdai", kcal:456, protein:9.7, fat:18, carbs:63, units:[{label:"1 pak. (85g)",grams:85}] },
  { id:"udon",         name:"Udon makaronai (virti)",             category:"Grūdai", kcal:96,  protein:2.8,  fat:0.5,  carbs:21,  units:[{label:"porcija (200g)",grams:200}] },
  { id:"rice_jasmine", name:"Jazmino ryžiai (virti)",             category:"Grūdai", kcal:130, protein:2.7,  fat:0.3,  carbs:28,  units:[{label:"porcija (150g)",grams:150}] },
  { id:"rice_basmati", name:"Basmati ryžiai (virti)",             category:"Grūdai", kcal:121, protein:2.5,  fat:0.4,  carbs:26,  units:[{label:"porcija (150g)",grams:150}] },
  { id:"bread_toast",  name:"Skrebučiai (balti)",                 barcode:"5010044003398", category:"Grūdai", kcal:313, protein:10, fat:3.8, carbs:62, units:[{label:"1 riekelė (25g)",grams:25},{label:"2 riekelės",grams:50}] },
  { id:"bread_multig", name:"Daugiagramūdinė duona",              category:"Grūdai", kcal:262, protein:12,   fat:5,    carbs:43,  units:[{label:"1 riekelė (35g)",grams:35}] },
  { id:"wheat_flour",  name:"Kvietiniai miltai (balt.)",          category:"Grūdai", kcal:364, protein:10,   fat:1,    carbs:76,  units:[{label:"1 šaukštas (10g)",grams:10}] },

  // ── DAUGIAU VAISIŲ ───────────────────────────────────────────────────
  { id:"tangerine",    name:"Mandarinas",                         category:"Vaisiai", kcal:53,  protein:0.8,  fat:0.3,  carbs:13,  units:[{label:"1 vnt (75g)",grams:75},{label:"2 vnt",grams:150}] },
  { id:"nectarine",    name:"Nektarinas",                         category:"Vaisiai", kcal:44,  protein:1.1,  fat:0.3,  carbs:11,  units:[{label:"1 vnt (130g)",grams:130}] },
  { id:"cantaloupe",   name:"Melionas (Cantaloupe)",              category:"Vaisiai", kcal:34,  protein:0.8,  fat:0.2,  carbs:8,   units:[{label:"porcija (150g)",grams:150}] },
  { id:"honeydew",     name:"Melionas (Honeydew)",                category:"Vaisiai", kcal:36,  protein:0.5,  fat:0.1,  carbs:9,   units:[{label:"porcija (150g)",grams:150}] },
  { id:"raspberry",    name:"Avietės",                            category:"Vaisiai", kcal:52,  protein:1.2,  fat:0.7,  carbs:12,  units:[{label:"½ puodelis (60g)",grams:60},{label:"1 puodelis (120g)",grams:120}] },
  { id:"blackberry",   name:"Gervuogės",                          category:"Vaisiai", kcal:43,  protein:1.4,  fat:0.5,  carbs:10,  units:[{label:"sauja (80g)",grams:80}] },
  { id:"cranberry_fr", name:"Spanguolės (šviežios)",              category:"Vaisiai", kcal:46,  protein:0.4,  fat:0.1,  carbs:12,  units:[{label:"sauja (80g)",grams:80}] },
  { id:"gooseberry",   name:"Agrastai",                           category:"Vaisiai", kcal:44,  protein:0.9,  fat:0.6,  carbs:10,  units:[{label:"sauja (80g)",grams:80}] },
  { id:"guava",        name:"Gvajava",                            category:"Vaisiai", kcal:68,  protein:2.6,  fat:1,    carbs:14,  units:[{label:"1 vnt (100g)",grams:100}] },
  { id:"jackfruit",    name:"Džekfrutas (žalias, konservuotas)",  category:"Vaisiai", kcal:95,  protein:1.7,  fat:0.1,  carbs:23,  units:[{label:"porcija (100g)",grams:100}] },
  { id:"dragon_fr",    name:"Pitaja (dragon fruit)",              category:"Vaisiai", kcal:60,  protein:1.2,  fat:0,    carbs:13,  units:[{label:"½ vnt (100g)",grams:100}] },

  // ── DAUGIAU ANKŠTINIŲ ────────────────────────────────────────────────
  { id:"chickpea_can", name:"Avinžirniai (konservuoti, nusausintas)", barcode:"5000396001625", category:"Ankštiniai", kcal:164, protein:8.9, fat:2.6, carbs:27, units:[{label:"½ skardinė (120g)",grams:120}] },
  { id:"lentil_red",   name:"Raudonieji lęšiai (virti)",           category:"Ankštiniai", kcal:116, protein:9,    fat:0.4,  carbs:20,  units:[{label:"porcija (150g)",grams:150}] },
  { id:"lentil_grn",   name:"Žalieji lęšiai (virti)",             category:"Ankštiniai", kcal:116, protein:9,    fat:0.4,  carbs:20,  units:[{label:"porcija (150g)",grams:150}] },
  { id:"white_beans",  name:"Baltosios pupelės (virtos)",          category:"Ankštiniai", kcal:139, protein:9.7,  fat:0.4,  carbs:25,  units:[{label:"porcija (150g)",grams:150}] },
  { id:"soy_beans",    name:"Sojos pupelės (virtos)",              category:"Ankštiniai", kcal:173, protein:17,   fat:9,    carbs:10,  units:[{label:"porcija (150g)",grams:150}] },
  { id:"tofu_soft",    name:"Tofu (minkštas)",                     category:"Ankštiniai", kcal:55,  protein:6,    fat:3,    carbs:1.4, units:[{label:"porcija (100g)",grams:100}] },
  { id:"lupini_b",     name:"Liubinas (lupini pupelės, sūdytos)",  category:"Ankštiniai", kcal:119, protein:16,   fat:3.2,  carbs:9,   units:[{label:"sauja (50g)",grams:50}] },

  // ── DAUGIAU SALDAINIŲ ────────────────────────────────────────────────
  { id:"wine_gums",    name:"Wine Gums guminukai",                barcode:"7622210055217", category:"Saldainiai", kcal:329, protein:5.5,  fat:0,    carbs:78,  units:[{label:"sauja (40g)",grams:40}] },
  { id:"licorice",     name:"Lakricos saldainiai",                barcode:"8710351008133", category:"Saldainiai", kcal:357, protein:5,    fat:1,    carbs:84,  units:[{label:"sauja (40g)",grams:40}] },
  { id:"pez_candy",    name:"PEZ saldainiai",                     category:"Saldainiai", kcal:383, protein:0,    fat:0,    carbs:96,  units:[{label:"1 ritinėlis (8g)",grams:8}] },
  { id:"hard_candy",   name:"Kieti saldainiai (mišrūs)",          category:"Saldainiai", kcal:390, protein:0,    fat:0,    carbs:98,  units:[{label:"1 saldainis (6g)",grams:6}] },
  { id:"mochi",        name:"Mochi ryžių pyragaitis",             category:"Saldainiai", kcal:235, protein:3.6,  fat:3.9,  carbs:50,  units:[{label:"1 vnt (44g)",grams:44}] },
  { id:"halva",        name:"Chalva (sezamų)",                    category:"Saldainiai", kcal:469, protein:11,   fat:30,   carbs:44,  units:[{label:"1 riekelė (40g)",grams:40}] },
  { id:"turkish_del",  name:"Turkish Delight",                    category:"Saldainiai", kcal:340, protein:0.5,  fat:0,    carbs:85,  units:[{label:"1 kubelis (20g)",grams:20}] },
  { id:"kit_kat_dar",  name:"KitKat Dark (tamsiojo šokolado)",    barcode:"7613035456403", category:"Saldainiai", kcal:507, protein:6.5, fat:27, carbs:62, units:[{label:"1 pak. (45g)",grams:45}] },
  { id:"after_eight",  name:"After Eight (mėtų šokoladas)",       barcode:"7613035059665", category:"Saldainiai", kcal:398, protein:3,   fat:14,   carbs:66,  units:[{label:"3 vnt (25g)",grams:25}] },
  { id:"lindt_85",     name:"Lindt 85% juodasis šokoladas",       barcode:"3046920028745", category:"Saldainiai", kcal:601, protein:8.5, fat:49,   carbs:37,  units:[{label:"2 plytelės (20g)",grams:20}] },

  // ── DAUGIAU RESTORANŲ ────────────────────────────────────────────────
  { id:"pad_thai",     name:"Pad Thai (su vištiena)",             category:"Restoranai", kcal:181, protein:14,   fat:6,    carbs:20,  units:[{label:"porcija (300g)",grams:300}] },
  { id:"fried_rice",   name:"Kepti ryžiai (su daržovėmis)",       category:"Restoranai", kcal:163, protein:4.4,  fat:4.8,  carbs:27,  units:[{label:"porcija (200g)",grams:200}] },
  { id:"naan_pizza",   name:"Naan pica",                          category:"Restoranai", kcal:286, protein:12,   fat:11,   carbs:36,  units:[{label:"1 vnt (150g)",grams:150}] },
  { id:"fish_chips",   name:"Fish and Chips",                     category:"Restoranai", kcal:295, protein:16,   fat:14,   carbs:28,  units:[{label:"porcija (300g)",grams:300}] },
  { id:"burrito",      name:"Buritas (su vištiena ir pupelėmis)", category:"Restoranai", kcal:231, protein:14,   fat:7.5,  carbs:28,  units:[{label:"1 buritas (250g)",grams:250}] },
  { id:"taco",         name:"Tacos (su jautiena)",                category:"Restoranai", kcal:245, protein:12,   fat:11,   carbs:25,  units:[{label:"1 tacos (100g)",grams:100}] },
  { id:"pho_soup",     name:"Pho sriuba (su jautiena)",           category:"Restoranai", kcal:68,  protein:6.5,  fat:1.5,  carbs:8,   units:[{label:"porcija (500ml)",grams:500}] },
  { id:"tom_yum",      name:"Tom Yum sriuba",                     category:"Restoranai", kcal:96,  protein:6,    fat:4,    carbs:9,   units:[{label:"porcija (350ml)",grams:350}] },
  { id:"doner_kebab",  name:"Donner Kebabas (su duona)",          category:"Restoranai", kcal:255, protein:15,   fat:10,   carbs:27,  units:[{label:"porcija (250g)",grams:250}] },
  { id:"calzone",      name:"Calzone (su sūriu ir kumpiu)",       category:"Restoranai", kcal:271, protein:14,   fat:10,   carbs:31,  units:[{label:"porcija (200g)",grams:200}] },

  // ── KONDITERIJA / KEPYKLA ────────────────────────────────────────────
  { id:"pain_choc",    name:"Pain au Chocolat",                   category:"Kepykla", kcal:420, protein:8,    fat:23,   carbs:48,  units:[{label:"1 vnt (75g)",grams:75}] },
  { id:"cinnamon_rol", name:"Cinamono bandelė",                   category:"Kepykla", kcal:420, protein:7,    fat:16,   carbs:63,  units:[{label:"1 vnt (100g)",grams:100}] },
  { id:"danish",       name:"Danišas (su uogiene)",               category:"Kepykla", kcal:372, protein:7.4,  fat:17,   carbs:49,  units:[{label:"1 vnt (80g)",grams:80}] },
  { id:"kouign",       name:"Briošas",                            category:"Kepykla", kcal:376, protein:8,    fat:18,   carbs:47,  units:[{label:"1 vnt (70g)",grams:70}] },
  { id:"english_muf",  name:"Angliškas muffinas",                 barcode:"5000168008990", category:"Kepykla", kcal:222, protein:8.4, fat:1.7, carbs:44, units:[{label:"1 vnt (57g)",grams:57}] },
  { id:"corn_bread",   name:"Kukurūzų duona",                     category:"Kepykla", kcal:198, protein:4.3,  fat:6,    carbs:33,  units:[{label:"1 riekelė (60g)",grams:60}] },
  { id:"pretzel_sof",  name:"Minkštas precelis",                  category:"Kepykla", kcal:340, protein:10,   fat:4,    carbs:65,  units:[{label:"1 vnt (115g)",grams:115}] },
  { id:"scone",        name:"Scone (angliškas pyragas)",          category:"Kepykla", kcal:364, protein:7.8,  fat:14,   carbs:53,  units:[{label:"1 vnt (60g)",grams:60}] },

  // ── KITI PAPILDAI / MAISTINIAI PRIEDAI ───────────────────────────────
  { id:"protein_oats", name:"Proteinoavižiai (paruošti)",         category:"Baltymų papildai", kcal:182, protein:14,   fat:4,    carbs:22,  units:[{label:"porcija (300ml)",grams:300}] },
  { id:"collagen_pwd", name:"Kolageno milteliai",                 category:"Baltymų papildai", kcal:36,  protein:9,    fat:0,    carbs:0,   units:[{label:"1 porcija (10g)",grams:10}] },
  { id:"spirulina",    name:"Spirulina (milteliai)",              category:"Baltymų papildai", kcal:290, protein:57,   fat:8,    carbs:24,  units:[{label:"1 šaukštelis (5g)",grams:5}] },
  { id:"oat_bran",     name:"Avižinės sėlenos",                  category:"Javai", kcal:246, protein:17,   fat:7,    carbs:66,  units:[{label:"2 šaukštai (20g)",grams:20}] },
  { id:"wheat_bran",   name:"Kvietinės sėlenos",                 category:"Javai", kcal:216, protein:16,   fat:4.3,  carbs:65,  units:[{label:"1 šaukštas (10g)",grams:10}] },
  { id:"coconut_fl",   name:"Kokosų miltai",                     category:"Grūdai", kcal:399, protein:18,   fat:15,   carbs:58,  units:[{label:"2 šaukštai (20g)",grams:20}] },
  { id:"almond_fl",    name:"Migdolų miltai",                    category:"Riešutai", kcal:579, protein:21,  fat:50,   carbs:22,  units:[{label:"2 šaukštai (20g)",grams:20}] },
  { id:"nutritional_y",name:"Maistiniai mieliai",                category:"Padažai", kcal:355, protein:50,   fat:6,    carbs:39,  units:[{label:"1 šaukštas (10g)",grams:10}] },
  { id:"maca_pwd",     name:"Maca milteliai",                    category:"Baltymų papildai", kcal:325, protein:14,   fat:3.6,  carbs:71,  units:[{label:"1 šaukštelis (5g)",grams:5}] },
  { id:"cacao_nibs",   name:"Kakavos truputėliai (cacao nibs)",  category:"Snacks", kcal:490, protein:13,   fat:28,   carbs:54,  units:[{label:"1 šaukštas (15g)",grams:15}] },
  { id:"apple_cider_v",name:"Obuolių acto gėrimas",             category:"Gėrimai", kcal:22,  protein:0,    fat:0,    carbs:5,   units:[{label:"1 šaukštas su vandeniu (250ml)",grams:250}] },
];

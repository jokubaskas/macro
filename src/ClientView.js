...
export default function ClientView({ user, onLogout }) {
  ...
  if (loading) return (
    <div style={{
      ...
      background: `linear-gradient(160deg, ${PK.pale}, #fff)`,
      ...
      <div style={{ maxWidth: 480, margin: "0 auto", padding: "16px 16px" }}>
        ...
        {!hasData ? (
          <div style={{
            ...
            <p style={{ color: PK.rose, fontSize: 14, fontWeight: 600, marginBottom: 6 }}>
              Tavo planas dar ruošiamas
            </p>
            <p style={{ color: PK.blush, fontSize: 12 }}>
              Trenerė netrukus užpildys tavo duomenis
            </p>
          </div>
        ) : (
          <>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
                ...
                <div>
                  <p style={{ fontSize: 14, fontWeight: 700, color: PK.dark, marginBottom: 2 }}>
                    {profile.name}
                  </p>
                  <p style={{ fontSize: 11, color: PK.rose }}>
                    {profile.age}m. · {profile.weight}kg · {profile.height}cm
                  </p>
                </div>
              </div>
            ...
            {[
              ...
              <div key={macro.label} style={{
                background: "#fff", borderRadius: 20, padding: "16px 14px", marginBottom: 10,
                border: `1px solid ${PK.blush}`,
                ...
                <div style={{ background: PK.light, borderRadius: 99, height: 6, marginBottom: 8 }}>
                  <div style={{
                    width: `${macro.data.pct}%`, height: "100%", borderRadius: 99,
                    background: `linear-gradient(90deg, ${macro.color}, ${PK.bright})`,
                  }} />
                </div>
